    ...
    async def run_pipeline(
        ...
        **kwargs,
        ...
        Args:
            ...
            **kwargs: Additional parameters (education, projects, certifications, location)
        ...
        try:
            ...
            if projects:
                logger.info(f"[ORCHESTRATOR] Found {len(projects)} projects to potentially merge with experiences")
                ...
                for proj in projects[:3]:  # Limit to 3 projects
                    if isinstance(proj, dict):
                        project_exp = {
                            "company": proj.get("name", "Personal Project"),
                ...
                logger.info(f"[ORCHESTRATOR] Total experiences after project merge: {len(experiences)}")
            ...
            if education or projects or certifications:
                logger.info(f"[ORCHESTRATOR] Additional sections: {len(education)} education, {len(projects)} projects, {len(certifications)} certifications")
