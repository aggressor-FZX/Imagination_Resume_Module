import re, json
resume='Senior Data Scientist with Python, AWS, SQL; built dashboards and ETL pipelines; no mention of Kubernetes.'
job='Senior Data Scientist - Required: Python, AWS, Data.'
